...
import { Stethoscope, Brain, Users, Star, ArrowRight, CheckCircle, Heart, Award, Clock } from "lucide-react"
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-xl font-bold text-slate-900">MedQuest</span>
                        </div>
                        <Link href='/sign-in' >
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <Card className="border-slate-200 shadow-xl bg-white/80 backdrop-blur hover:shadow-2xl transition-all duration-300">
                            <CardContent className="p-8">
                                ...
                                <p className="text-slate-600 mb-6 leading-relaxed">
                                    The smart learning feature is a game-changer. It identified my weak areas and helped me focus my
                                    study time effectively for all my medical courses.
                                </p>
                                <div className="flex items-center">
